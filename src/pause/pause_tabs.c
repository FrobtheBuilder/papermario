...
void pause_tabs_handle_input(MenuPanel* tab) {
    ...
    if (tab->col != gPauseTabsCurrentTab) {
        replace_window_update(gPauseTabsWindowIDs[tab->col], 0x40, WUPDATE_FUNC(pause_update_tab_active));
        replace_window_update(gPauseTabsWindowIDs[gPauseTabsCurrentTab], 0x40, WUPDATE_FUNC(pause_update_tab_inactive));
