...
MsgID gPauseMessages[] = {
...
#if !VERSION_PAL
    [PAUSE_MSG_17]                  MSGID_AS_PTR(gPauseMsg_17),
    [PAUSE_MSG_18]                  MSGID_AS_PTR(gPauseMsg_18),
    [PAUSE_MSG_19]                  MSGID_AS_PTR(gPauseMsg_19),
    [PAUSE_MSG_1A]                  MSGID_AS_PTR(gPauseMsg_1A),
#endif
    ...
    [PAUSE_MSG_LBL_COINS]           MSGID_AS_PTR(gPauseMsg_32),
    [PAUSE_MSG_LBL_STAR_POINTS]     MSGID_AS_PTR(gPauseMsg_33),
    [PAUSE_MSG_LBL_STAR_PIECES]     MSGID_AS_PTR(gPauseMsg_34),
    [PAUSE_MSG_LBL_TIME]            MSGID_AS_PTR(gPauseMsg_35),
    [PAUSE_MSG_LBL_HP]              MSGID_AS_PTR(gPauseMsg_36),
    [PAUSE_MSG_LBL_FP]              MSGID_AS_PTR(gPauseMsg_37),
    [PAUSE_MSG_LBL_BP]              MSGID_AS_PTR(gPauseMsg_38),
    [PAUSE_MSG_SLASH]               MSGID_AS_PTR(gPauseMsg_39),
    [PAUSE_MSG_DOT]                 MSGID_AS_PTR(gPauseMsg_3A),
#if !VERSION_PAL
    [PAUSE_MSG_3B]                  MSGID_AS_PTR(gPauseMsg_3B),
#endif
    [PAUSE_MSG_3C]                  MSGID_AS_PTR(gPauseMsg_3C),
    [PAUSE_MSG_3D]                  MSGID_AS_PTR(gPauseMsg_3D),
    [PAUSE_MSG_3E]                  MSGID_AS_PTR(gPauseMsg_3E),
#if !VERSION_PAL
    [PAUSE_MSG_3F]                  MSGID_AS_PTR(gPauseMsg_3F),
#endif
    [PAUSE_MSG_40]                  MSGID_AS_PTR(gPauseMsg_40),
    [PAUSE_MSG_41]                  MSGID_AS_PTR(gPauseMsg_41),
    [PAUSE_MSG_42]                  MSGID_AS_PTR(gPauseMsg_42),
    [PAUSE_MSG_MARIO]               MSGID_AS_PTR(gPauseMsg_43),
    [PAUSE_MSG_LEVEL]               MSGID_AS_PTR(gPauseMsg_44),
    [PAUSE_MSG_NO_BADGE]            MSG_MenuTip_None,
    [PAUSE_MSG_BADGE_BP]            MSGID_AS_PTR(gPauseMsg_46),
    [PAUSE_MSG_ALL_BADGES]          MSGID_AS_PTR(gPauseMsg_47),
#if VERSION_PAL
    [PAUSE_MSG_PAL_42]              MSGID_AS_PTR(gPauseMsg_PAL_42),
#endif
    [PAUSE_MSG_ACTIVE]              MSGID_AS_PTR(gPauseMsg_48),
#if !VERSION_JP
    [PAUSE_MSG_BADGES]              MSGID_AS_PTR(gPauseMsg_49),
#endif
    [PAUSE_MSG_NOT_ENOUGH_BP]       MSGID_AS_PTR(gPauseMsg_4A),
    [PAUSE_MSG_DONT_WEAR_MORE]      MSGID_AS_PTR(gPauseMsg_4B),
    ...
    [PAUSE_MSG_KEY_ITEMS]           MSGID_AS_PTR(gPauseMsg_4F),
#if VERSION_PAL
    [PAUSE_MSG_PAL_4B]              MSGID_AS_PTR(gPauseMsg_PAL_4B),
#endif
    [PAUSE_MSG_CONSUMABLES]         MSGID_AS_PTR(gPauseMsg_50),
    [PAUSE_MSG_DESC_CONSUMABLES]    MSG_MenuTip_ItemTab_Consumables,
    [PAUSE_MSG_DESC_KEY_ITEMS]      MSG_MenuTip_ItemTab_KeyItems,
    [PAUSE_MSG_PARTNER_HP]          MSGID_AS_PTR(gPauseMsg_53),
    [PAUSE_MSG_PARTNER_FP]          MSGID_AS_PTR(gPauseMsg_54),
    [PAUSE_MSG_PARTNER_ABILITIES]   MSGID_AS_PTR(gPauseMsg_55),
    [PAUSE_MSG_UNKNOWN_SPIRIT]      MSGID_AS_PTR(gPauseMsg_56),
};
...
MsgID pause_get_menu_msg(s32 index) {
